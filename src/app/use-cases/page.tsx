        ...
        <div className="space-y-8">
          {cases.map((c, idx) => (
            <div key={idx} className="bg-white border border-slate-200 shadow-sm rounded-3xl p-8 flex flex-col md:flex-row gap-8 items-start md:items-center hover:shadow-md transition-shadow">
              ...
              <Link href="/dashboard" className="bg-slate-900 text-white px-5 py-3 rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-slate-800 transition-colors flex items-center shrink-0 w-full md:w-auto justify-center group">
                {c.cta}
